...
# Using the specific config requested by the user
config = os.path.join(BASE, "configs/hrnet/hrnet_w48_coco_384x288.py")

# Checkpoint for HRNet-w48 384x288
...
out_dir = os.path.join(BASE, "results", "hrnet_w48")
...
print(f"Model: HRNet-w48 (384x288)")
