...
config = os.path.join(BASE, "configs", "vitpose_base_384x288.py")
checkpoint = os.path.join(BASE, "checkpoints", "vitpose_base_384x288_patched.pth")

out_dir = os.path.join(BASE, "results", "vitpose_base_384x288")
...
print(f"Model: ViTPose-base (384x288)")
